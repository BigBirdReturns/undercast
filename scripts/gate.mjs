...
const stepDefinitions = [
  ...
  { id: "collection-mode", label: "Validate collection-only operations and estate registry", action: () => { runNpmScript("Corpus operations fixtures", "corpus:fixtures"); runNpmScript("Corpus operations validate", "corpus", ["--", "validate"]); runNpmScript("Media search fixtures", "media:search:fixtures"); } },
