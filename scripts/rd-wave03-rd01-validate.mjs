...
export const PROTOCOL_PATH = "data/research/residual-denominator/wave-03/rd-01/protocol.json";
export const SCHEMA_PATH = "schema/rd-wave03-rd01-intake.schema.json";
export const MATRIX_PATH = "data/research/residual-denominator/wave-03/rd-01/field-matrix.json";
export const WORKFLOW_PATH = ".github/workflows/rd-wave03-rd01-intake.yml";
export const EXPECTED_PATHS = ["data/research/residual-denominator/wave-03/rd-01/protocol.json", "data/research/residual-denominator/wave-03/rd-01/field-matrix.json", "schema/rd-wave03-rd01-intake.schema.json", "scripts/rd-wave03-rd01-build.mjs", "scripts/rd-wave03-rd01-validate.mjs", "test/rd-wave03-rd01-adversarial.mjs", ".github/workflows/rd-wave03-rd01-intake.yml", "docs/research/residual-denominator/wave-03/RD-01.md"];
const EXPECTED_SCHEMA_SHA256 = "01025f533fa9e560149c678b3c3c3b1a67193a38b1cbef0b09d0f025f3011468";
const EXPECTED_LANE = "RD-01";
const EXPECTED_UNIT_COUNT = 3;
const EXPECTED_FIELD_COUNT = 8;
const EXPECTED_CELL_COUNT = 24;
const EXPECTED_OFFICIAL_COUNT = 3;
const EXPECTED_CANDIDATE_COUNT = 27;
const EXPECTED_TOTAL_COUNT = 30;
const EXPECTED_MATRIX_MODE = "separate_immutable_input";
