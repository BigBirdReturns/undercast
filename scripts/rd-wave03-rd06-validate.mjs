...
export const PROTOCOL_PATH = "data/research/residual-denominator/wave-03/rd-06/protocol.json";
export const SCHEMA_PATH = "schema/rd-wave03-rd06-intake.schema.json";
export const MATRIX_PATH = "data/research/residual-denominator/wave-03/rd-06/field-matrix.json";
export const WORKFLOW_PATH = ".github/workflows/rd-wave03-rd06-intake.yml";
export const EXPECTED_PATHS = ["data/research/residual-denominator/wave-03/rd-06/protocol.json", "data/research/residual-denominator/wave-03/rd-06/field-matrix.json", "schema/rd-wave03-rd06-intake.schema.json", "scripts/rd-wave03-rd06-build.mjs", "scripts/rd-wave03-rd06-validate.mjs", "test/rd-wave03-rd06-adversarial.mjs", ".github/workflows/rd-wave03-rd06-intake.yml", "docs/research/residual-denominator/wave-03/RD-06.md"];
const EXPECTED_SCHEMA_SHA256 = "0f444c78251b5fe55e757618844a359fdbc050f8cf6282ccedf18a8c45b3745c";
const EXPECTED_LANE = "RD-06";
const EXPECTED_UNIT_COUNT = 8;
const EXPECTED_FIELD_COUNT = 10;
const EXPECTED_CELL_COUNT = 80;
const EXPECTED_OFFICIAL_COUNT = 4;
const EXPECTED_CANDIDATE_COUNT = 32;
const EXPECTED_TOTAL_COUNT = 36;
