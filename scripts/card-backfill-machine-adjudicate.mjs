...
function promptFor(review, sourceReceipt) {
  ...
  return [
    ...
    "4. For a portrait, `neutral-human` means an ordinary out-of-character human presentation: no role makeup, creature suit, full public-persona mask, or character treatment.",
    ...
    "6. Ambiguity, weak source binding, group ambiguity, wrong presentation, screenshots of text/UI, logos, or unusable framing require rejection.",
    "7. Be conservative. The caller will apply an additional confidence threshold and will fail closed.",
    "",
