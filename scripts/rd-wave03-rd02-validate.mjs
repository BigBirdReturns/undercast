...
export const PROTOCOL_PATH = "data/research/residual-denominator/wave-03/rd-02/protocol.json";
export const SCHEMA_PATH = "schema/rd-wave03-rd02-intake.schema.json";
export const MATRIX_PATH = null;
export const WORKFLOW_PATH = ".github/workflows/rd-wave03-rd02-intake.yml";
export const EXPECTED_PATHS = ["data/research/residual-denominator/wave-03/rd-02/protocol.json", "schema/rd-wave03-rd02-intake.schema.json", "scripts/rd-wave03-rd02-build.mjs", "scripts/rd-wave03-rd02-validate.mjs", "test/rd-wave03-rd02-adversarial.mjs", ".github/workflows/rd-wave03-rd02-intake.yml", "docs/research/residual-denominator/wave-03/RD-02.md"];
const EXPECTED_SCHEMA_SHA256 = "473b05b90c3c3cb0388e624233659d3ae668a5a2744237ac3f69eec8fe53b656";
const EXPECTED_LANE = "RD-02";
const EXPECTED_UNIT_COUNT = 18;
const EXPECTED_FIELD_COUNT = 10;
const EXPECTED_CELL_COUNT = 180;
const EXPECTED_OFFICIAL_COUNT = 5;
const EXPECTED_CANDIDATE_COUNT = 136;
const EXPECTED_TOTAL_COUNT = 141;
