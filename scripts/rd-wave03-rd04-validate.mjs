...
export const PROTOCOL_PATH = "data/research/residual-denominator/wave-03/rd-04/protocol.json";
export const SCHEMA_PATH = "schema/rd-wave03-rd04-intake.schema.json";
export const MATRIX_PATH = null;
export const WORKFLOW_PATH = ".github/workflows/rd-wave03-rd04-intake.yml";
export const EXPECTED_PATHS = ["data/research/residual-denominator/wave-03/rd-04/protocol.json", "schema/rd-wave03-rd04-intake.schema.json", "scripts/rd-wave03-rd04-build.mjs", "scripts/rd-wave03-rd04-validate.mjs", "test/rd-wave03-rd04-adversarial.mjs", ".github/workflows/rd-wave03-rd04-intake.yml", "docs/research/residual-denominator/wave-03/RD-04.md"];
const EXPECTED_SCHEMA_SHA256 = "8bc7ce34de98461bad377d8d5bf3084e2ef4290059eba36340b8a726a22fe367";
const EXPECTED_LANE = "RD-04";
const EXPECTED_UNIT_COUNT = 50;
const EXPECTED_FIELD_COUNT = 9;
const EXPECTED_CELL_COUNT = 450;
const EXPECTED_OFFICIAL_COUNT = 7;
const EXPECTED_CANDIDATE_COUNT = 300;
const EXPECTED_TOTAL_COUNT = 307;
