...
export const PROTOCOL_PATH = "data/research/residual-denominator/wave-03/rd-05/protocol.json";
export const SCHEMA_PATH = "schema/rd-wave03-rd05-intake.schema.json";
export const MATRIX_PATH = "data/research/residual-denominator/wave-03/rd-05/field-matrix.json";
export const WORKFLOW_PATH = ".github/workflows/rd-wave03-rd05-intake.yml";
export const EXPECTED_PATHS = ["data/research/residual-denominator/wave-03/rd-05/protocol.json", "data/research/residual-denominator/wave-03/rd-05/field-matrix.json", "schema/rd-wave03-rd05-intake.schema.json", "scripts/rd-wave03-rd05-build.mjs", "scripts/rd-wave03-rd05-validate.mjs", "test/rd-wave03-rd05-adversarial.mjs", ".github/workflows/rd-wave03-rd05-intake.yml", "docs/research/residual-denominator/wave-03/RD-05.md"];
const EXPECTED_SCHEMA_SHA256 = "fac1f1cc1372c4f323f5d2dd15990a8cd3ea832d935aa7db0acfbb1abebe2a94";
const EXPECTED_LANE = "RD-05";
const EXPECTED_UNIT_COUNT = 17;
const EXPECTED_FIELD_COUNT = 10;
const EXPECTED_CELL_COUNT = 170;
const EXPECTED_OFFICIAL_COUNT = 27;
const EXPECTED_CANDIDATE_COUNT = 119;
const EXPECTED_TOTAL_COUNT = 146;
