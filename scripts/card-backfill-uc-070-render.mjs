...
assert(pageEvidence?.status==='loaded'&&pageEvidence?.required_terms_missing?.length===0,'selected ILM page evidence incomplete');
assert(String(pageEvidence.body_text||'').includes('Bill Nighy')&&String(pageEvidence.body_text||'').includes('Davy Jones'),'selected ILM article evidence drift');
