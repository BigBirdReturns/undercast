...
The public product is the [live wall](https://bigbirdreturns.github.io/undercast/) and its [coverage surface](https://bigbirdreturns.github.io/undercast/coverage.html). The accepted UnderCast 1.0 boundary is fixed in the [1.0 baseline receipt](https://bigbirdreturns.github.io/undercast/release-1.0.json). The mutable [current deployment receipt](https://bigbirdreturns.github.io/undercast/release.json) binds the commit, tree, inputs, media, and payload now served. `npm run gate` is the release gate.
