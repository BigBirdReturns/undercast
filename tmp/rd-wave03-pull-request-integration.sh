...
helper_path=tmp/rd-wave03-pull-request-integration.sh
workflow_path=.github/workflows/rd-wave03-pull-request-qualification.yml
...
git show "$qualification_head:$workflow_path" > "$evidence/rd-wave03-pull-request-qualification.yml"
...
"$evidence/actionlint" -shellcheck= "$evidence/rd-wave03-pull-request-qualification.yml" .github/workflows/rd-wave03-rd*-intake.yml
