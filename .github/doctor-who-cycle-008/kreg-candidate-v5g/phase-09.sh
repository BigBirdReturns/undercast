...
git -C "$WORKTREE" branch -f cycle008-kreg-candidate-v5g "$candidate_commit"
git -C "$WORKTREE" bundle create "$OUT/candidate.bundle" cycle008-kreg-candidate-v5g ^"$base_sha"
...
PY
test "$(sha256sum "$OUT/candidate-product.tar.gz" | awk '{print $1}')" = 6aa5da92ab49a7c0429c8481a4bec4a957abd9339cae58b0f6fd61e4a06fb705
...
receipt={
  'version':1,
  'transaction':'DOCTOR-WHO-CYCLE-008-KREG-CANDIDATE-V5G-QUALIFICATION',
